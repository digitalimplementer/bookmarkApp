...
export type IconMap = {
   ...
   clipRule?: 'inherit' | 'evenodd' | 'nonzero' | undefined;
};

export const IconPath = new Map<string, IconMap>()
   .set(ENUM_ICON.VISIBLE, {
